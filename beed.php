...
<div class="row">
  <div class="col-sm-8">
    <div class="alert alert-danger alert-dismissible fade in">
        ...
        <h5><b><strong>Danger!</strong> <blink>Beed may receive extreme drought till year 2025.</blink></b></h5>
        <p>Click button below to show possible re-route path for solution.</p>
        <a href="rno\beed.html" class="btn btn-danger">River Map</a>
    </div>
  </div>
</div>
